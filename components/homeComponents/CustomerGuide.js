            ...
            <div className="flex items-center justify-center max-w-4xl w-full">
                ...
                <div className="mx-2 md:mx-3 lg:mx-6 space-y-6 md:space-y-7 lg:space-y-10">
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-5 lg:p-6 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-yellow-500/20 flex items-center transform hover:-translate-y-2">
                        <Image src="https://cdn-icons-png.flaticon.com/256/14477/14477419.png" alt="Create Account" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl shadow-lg mr-3 md:mr-4 lg:mr-5 transition-transform hover:rotate-12" width={96} height={96} />
                    ...
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-5 lg:p-6 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 flex items-center transform hover:-translate-y-2">
                        <Image src="https://cdn-icons-png.flaticon.com/256/8524/8524504.png" alt="Record Video" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl shadow-lg mr-3 md:mr-4 lg:mr-5 transition-transform hover:rotate-12" width={96} height={96} />
                        <div className="ml-2 md:ml-3 lg:ml-4">
                    ...
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-5 lg:p-6 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 flex items-center transform hover:-translate-y-2">
                        <Image src="https://cdn-icons-png.flaticon.com/256/6663/6663862.png" alt="Chat with Retailers" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl shadow-lg mr-3 md:mr-4 lg:mr-5 transition-transform hover:rotate-12" width={96} height={96} />
                        <div className="ml-2 md:ml-3 lg:ml-4">
                    ...
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-5 lg:p-6 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-green-500/20 flex items-center transform hover:-translate-y-2">
                        <Image src="https://cdn-icons-png.flaticon.com/256/5149/5149035.png" alt="Make A Deal" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl shadow-lg mr-3 md:mr-4 lg:mr-5 transition-transform hover:rotate-12" width={96} height={96} />
                        <div className="ml-2 md:ml-3 lg:ml-4">
