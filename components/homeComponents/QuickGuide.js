            ...
            <div className="flex items-center justify-center max-w-6xl w-full">
                ...
                <div className="mx-4 md:mx-4 lg:mx-8 space-y-8 md:space-y-8 lg:space-y-12">
                    ...
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 flex items-center transform hover:-translate-y-2">
                        <Image src="https://cdn-icons-png.flaticon.com/256/8524/8524504.png" alt="Record Video" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl shadow-lg mr-4 md:mr-6 lg:mr-8 transition-transform hover:rotate-12" width={96} height={96} />
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-3xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Record Your Query</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-lg leading-relaxed">Record Your Query and Select relevant category</p>
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 flex items-center transform hover:-translate-y-2">
                        ...
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-3xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Chat With Retailers</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-lg leading-relaxed">Get responses from the retailers and chat with them for futher information</p>
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-green-500/20 flex items-center transform hover:-translate-y-2">
                        <Image src="https://cdn-icons-png.flaticon.com/256/5149/5149035.png" alt="Make A Deal" className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl shadow-lg mr-4 md:mr-6 lg:mr-8 transition-transform hover:rotate-12" width={96} height={96} />
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-3xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">Make A Deal</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-lg leading-relaxed">Make a deal that fits your conditions and review the services provided by the Retailer</p>
                        </div>
                    </div>
                </div>
            </div>
