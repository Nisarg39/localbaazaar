                ...
                <div className="mx-4 md:mx-4 lg:mx-8 space-y-8 md:space-y-8 lg:space-y-12">
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-yellow-500/20 flex items-center transform hover:-translate-y-2">
                        ...
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Create An Account</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-sm leading-relaxed">Sign up through app for LocalBaazaar account to start your journey.</p>
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 flex items-center transform hover:-translate-y-2">
                        ...
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Register Your Shop</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-sm leading-relaxed">Enter details about your Shop correctly to get registered.</p>
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-green-500/20 flex items-center transform hover:-translate-y-2">
                        ...
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">Wait For The Customer's Request</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-sm leading-relaxed">You will be notified whenever a Customer makes a request in your area.</p>
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 flex items-center transform hover:-translate-y-2">
                        ...
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Send A Response Immediately</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-sm leading-relaxed">Send a response video quickly to increase your chance of getting a deal.</p>
                        </div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-900 to-black p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 flex items-center transform hover:-translate-y-2">
                        ...
                        <div className="ml-2 md:ml-3 lg:ml-4">
                            <h3 className="text-xl md:text-lg lg:text-xl font-bold mb-2 md:mb-3 lg:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600">Chat With Customer</h3>
                            <p className="mb-2 text-gray-300 text-sm md:text-xs lg:text-sm leading-relaxed">Chat with customers if they have any query regarding your offer.</p>
                        </div>
                    </div>
                </div>
            </div>
